  ...
  <div class="account-menu">
    <form class="account-menu__form" @submit="onSubmit" v-if="user === null">
      ...
      <div class="account-menu__form-link">
        <AppLink :to="$url.signUp()"> Create An Account </AppLink>
      </div>
    </form>
    <template v-if="user !== null">
      ...
      <ul class="account-menu__links">
        <li>
          <AppLink :to="$url.accountProfile()"> Edit Profile </AppLink>
        </li>
        <li>
          <AppLink :to="$url.accountOrders()"> Order History </AppLink>
        </li>
        <li>
          <AppLink :to="$url.accountAddresses()"> Addresses </AppLink>
        </li>
        <li>
          <AppLink :to="$url.accountPassword()"> Password </AppLink>
        </li>
      </ul>
      <div class="account-menu__divider" />
      <ul class="account-menu__links">
        <li>
          <b-button @click="logout" block> Logout </b-button>
        </li>
      </ul>
    </template>
  </div>
